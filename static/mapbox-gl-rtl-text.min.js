	...
	(function (global, factory) {
		...
		var asm = (function (global, env, buffer) {
			...
			function ea(b, e, f, g, h) {
				...
				d: do {
					if (
						(a[t >> 0] | 0 ? (c[k >> 2] & 1) | 0 : 0) ? (((c[u >> 2] | 0) + -5) | 0) >>> 0 < 2 : 0
					) {
						g = 0;
						while (1) {
					...
					a: do {
						if (!((($(c[h >> 2] | 0) | 0) << 24) >> 24)) {
							...
							if (!j) t = p;
								...
								if (
									!(
										((aa(g, (b + 36) | 0, a[(b + 69) >> 0] | 0, (((j + q) | 0) * 12) | 0) | 0) <<
											24) >>
										24
									)
								)
							...
							b: do {
								switch (a[(I + i) >> 0] | 0) {
									...
									case 7: {
										...
										if ((h | 0) < (H | 0)) {
											if (
												(b[(G + (i << 1)) >> 1] | 0) == 13 ? (b[(G + (h << 1)) >> 1] | 0) == 10 : 0
											)
												break b;
											ta(o, j);
										}
						...
						switch ((l << 24) >> 24) {
							...
							default: {
								...
								if (((j & 127) | 0) == ((g & 127) | 0)) n = h;
									...
									va(C, m, g, q);
									n =
										c[((((j & 128) | 0) == 0 ? 70024 : 70016) + ((j & 1) << 2)) >> 2] |
										(h | -2147483648);
								}
								a[(K + t) >> 0] = q;
								if (!(((ua(C, t) | 0) << 24) >> 24)) {
				...
				a: do {
					switch (a[(p + (q >>> 4)) >> 0] | 0) {
						...
						case 5: {
							...
							if (
								c[(b + 328) >> 2] | 0
									? ((m = (b + 332) | 0), (n = (b + 336) | 0), (c[m >> 2] | 0) > (c[n >> 2] | 0))
									: 0
							) {
								j = (e + 16) | 0;
								i = c[j >> 2] | 0;
						...
						case 7: {
							if (
								((f << 24) >> 24 == 3 ? (a[((c[(b + 72) >> 2] | 0) + g) >> 0] | 0) == 5 : 0)
									? (c[(b + 84) >> 2] | 0) != 6
									: 0
							) {
								i = (e + 12) | 0;
				...
				do {
					if ((m << 24) >> 24 == 10) {
						...
						if (
							(
								(h << 16) >> 16
									? ((k = (zb(j) | 0) & 65535), (h << 16) >> 16 != (k << 16) >> 16)
									: 0
							)
								? (wb(j) | 0) == 1
								: 0
			...
			function ya(d, f, g) {
				...
				if (!k) {
					...
					while (1) {
						...
						if (
							(c[((c[q >> 2] | 0) + (((((j & 65535) + -1) | 0) * 24) | 0)) >> 2] | 0) ==
							(c[n >> 2] | 0)
						)
							j = ((j + -1) << 16) >> 16;
						else {
			...
			function Ab(a) {
				...
				if (
					a | 0
						? ((l = c[17702] | 0), (n = (l + k) | 0), (n >>> 0 <= l >>> 0) | (n >>> 0 > a >>> 0))
						: 0
				) {
					s = 0;
					E = t;
				...
				f: do {
					if (j) {
						...
						while (1) {
							d = c[a >> 2] | 0;
							if (
								d >>> 0 <= j >>> 0 ? ((s = (d + (c[(a + 4) >> 2] | 0)) | 0), s >>> 0 > j >>> 0) : 0
							)
								break;
							a = c[(a + 8) >> 2] | 0;
						}
			...
			for (var i = 0; i < paragraphCount; i++) {
				...
				for (var i$1 = 0, list = lineBreakPoints; i$1 < list.length; i$1 += 1) {
					...
					if (
						...
						(!mergedParagraphLineBreakPoints[mergedParagraphLineBreakPoints.length - 1] ||
							lineBreakPoint >
								mergedParagraphLineBreakPoints[mergedParagraphLineBreakPoints.length - 1])
					) {
