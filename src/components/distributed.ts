const martinpool = [
    "https://martin.catenarymaps.org",
    "https://martinmeerkat.catenarymaps.org",
];

const kactuspool = [
    "https://kactus.catenarymaps.org",
    "https://kactus-meerkat.catenarymaps.org",
];

const backendpool = [
    "https://backend.catenarymaps.org",
    "https://backend-meerkatcatenarymaps.org"
]
...
export function check_martin() {
    martinpool.forEach((url) => {
        fetch(url + "/catalog").then((response) => {
...
export function check_kactus() {
    kactuspool.forEach((url) => {
        fetch(url + "/gtfsrttimes").then((response) => {
