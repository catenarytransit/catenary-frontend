<script lang="ts">
    ...
    onMount(() => {
       ...
       map.on('load', () => {
        ...
        fetch("https://gist.githubusercontent.com/kylerchin/0d91c3652d9546d0dfdf77d90ba03820/raw/009e4b4762210ce5abf6e576bf208cdad43d1e65/rail_stops_query_filtered.json")
