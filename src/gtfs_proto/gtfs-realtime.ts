...
export namespace transit_realtime {
	export class FeedMessage extends pb_1.Message {
		...
		serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
			...
			if (this.entity.length) writer.writeRepeatedMessage(2, this.entity, (item: FeedEntity) => item.serialize(writer));
				...
				switch (reader.getFieldNumber()) {
					...
					case 2:
						reader.readMessage(message.entity, () =>
							pb_1.Message.addToRepeatedWrapperField(message, 2, FeedEntity.deserialize(reader), FeedEntity)
						);
						break;
					default:
						reader.skipField();
	...
	export class FeedEntity extends pb_1.Message {
		...
		serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
			...
			if (this.has_trip_update) writer.writeMessage(3, this.trip_update, () => this.trip_update.serialize(writer));
			if (this.has_vehicle) writer.writeMessage(4, this.vehicle, () => this.vehicle.serialize(writer));
	...
	export class TripUpdate extends pb_1.Message {
		...
		serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
			...
			if (this.has_vehicle) writer.writeMessage(3, this.vehicle, () => this.vehicle.serialize(writer));
	...
	export namespace TripUpdate {
		export class StopTimeEvent extends pb_1.Message {
			...
			static fromObject(data: { delay?: number; time?: number; uncertainty?: number }): StopTimeEvent {
		...
		export class StopTimeUpdate extends pb_1.Message {
			...
			serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
				...
				if (this.has_arrival) writer.writeMessage(2, this.arrival, () => this.arrival.serialize(writer));
				if (this.has_departure) writer.writeMessage(3, this.departure, () => this.departure.serialize(writer));
	...
	export class VehiclePosition extends pb_1.Message {
		...
		serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
			const writer = w || new pb_1.BinaryWriter();
			if (this.has_trip) writer.writeMessage(1, this.trip, () => this.trip.serialize(writer));
			if (this.has_vehicle) writer.writeMessage(8, this.vehicle, () => this.vehicle.serialize(writer));
	...
	export class Alert extends pb_1.Message {
		...
		serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
			...
			if (this.has_header_text) writer.writeMessage(10, this.header_text, () => this.header_text.serialize(writer));
				...
				switch (reader.getFieldNumber()) {
					case 1:
						reader.readMessage(message.active_period, () =>
							pb_1.Message.addToRepeatedWrapperField(message, 1, TimeRange.deserialize(reader), TimeRange)
						);
						break;
					case 5:
						reader.readMessage(message.informed_entity, () =>
							pb_1.Message.addToRepeatedWrapperField(message, 5, EntitySelector.deserialize(reader), EntitySelector)
						);
						break;
					case 6:
	...
	export class VehicleDescriptor extends pb_1.Message {
		...
		static fromObject(data: { id?: string; label?: string; license_plate?: string }): VehicleDescriptor {
		...
		serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
			...
			if (this.has_license_plate && this.license_plate.length) writer.writeString(3, this.license_plate);
			if (!w) return writer.getResultBuffer();
		}
