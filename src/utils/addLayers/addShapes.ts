...
export function addShapes(map: any, darkMode: boolean, layerspercategory: any) {
	...
	map.addLayer({
		...
		filter: [
			...
			[
				'!',
				['all', ['==', 'f-9mu-mts', ['get', 'onestop_feed_id']], ['==', ['coalesce', ['get', 'route_label']], '950']]
			],
			[
				'!',
				[
	...
	map.addLayer({
		...
		layout: {
			...
			'text-field': urlParams.get('debug')
				? ['concat', ['get', 'onestop_feed_id'], '|', ['get', 'shape_id'], '|', ['coalesce', ['get', 'route_label']]]
	...
	map.addLayer({
		...
		filter: [
			'all',
			['any', ['==', 4, ['get', 'route_type']], ['==', 6, ['get', 'route_type']], ['==', 7, ['get', 'route_type']]]
		],
		layout: {
			'symbol-placement': 'line',
			'text-field': ['coalesce', ['get', 'route_label']],
	...
	map.addLayer({
		...
		source: 'notbusshapes',
		'source-layer': 'notbus',
		filter: ['all', ['any', ['==', 2, ['get', 'route_type']]]],
		paint: {
			'line-color': ['concat', '#', ['get', 'color']],
			'line-width': ['interpolate', ['linear'], ['zoom'], 7, 2, 9, 3],
			'line-opacity': 1,
