...
export function getMtaSubwayClass(shortName: string): string {
	...
	const subwayRouteClasses: { [key: string]: string } = {
		...
		'4': 'mta-green', '5': 'mta-green', '6': 'mta-green', '6X': 'mta-green',
		'A': 'mta-blue', 'C': 'mta-blue', 'E': 'mta-blue',
		'B': 'mta-orange', 'D': 'mta-orange', 'F': 'mta-orange', 'FX': 'mta-orange', 'M': 'mta-orange',
		'G': 'mta-green-2',
		'J': 'mta-brown', 'Z': 'mta-brown',
		'L': 'mta-gray',
		'N': 'mta-yellow', 'Q': 'mta-yellow', 'R': 'mta-yellow', 'W': 'mta-yellow',
		'GS': 'mta-gray', 'FS': 'mta-gray', 'H': 'mta-gray', // Shuttles
		'7': 'mta-purple', '7X': 'mta-purple'
	};
...
const SUBWAY_ROUTE_IDS = new Set([
	'A', 'C', 'E', 'B', 'D', 'F', 'FX', 'M', 'G', 'J', 'Z', 'L', 'N', 'Q', 'R', 'W', 'GS', 'FS', 'H', '1', '2', '3', '4', '5', '6', '6X', '7', '7X'
]);
